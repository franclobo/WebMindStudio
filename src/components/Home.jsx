    ...
    <main>
      ...
      <section className="services" id="services">
        <div className="servicio basico">
          ...
          <strong className="basico__description">Desde: CLP $499000</strong>
        </div>
        <div className="servicio avanzado">
          ...
          <strong className="avanzado__description">Desde: CLP $1499000</strong>
        </div>
        <div className="servicio premium">
          ...
          <strong className="premium__description">Desde: CLP $2999000</strong>
        </div>
      </section>
